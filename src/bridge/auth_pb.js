...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.bridge.UsernameAndPassword.displayName =
    "proto.bridge.UsernameAndPassword"
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.bridge.UsernameAndPassword.prototype.toObject = function(
    opt_includeInstance
  ) {
...
proto.bridge.UsernameAndPassword.deserializeBinary = function(bytes) {
  ...
  return proto.bridge.UsernameAndPassword.deserializeBinaryFromReader(
    msg,
    reader
  )
}
 ...
 * @return {!proto.bridge.UsernameAndPassword}
 */
proto.bridge.UsernameAndPassword.deserializeBinaryFromReader = function(
  msg,
  reader
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bridge.UsernameAndPassword.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined
